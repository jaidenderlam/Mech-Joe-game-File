...
function drawStart() {
   ...
   // scores bar
    ...
    // distance
       shapes.font = "bold 180% Times New Roman";
       shapes.fillStyle = "red";
       shapes.fillText("Distance: " + distanceConversion() ,c.width/2 - 250 ,c.height*0.93);
       shapes.fillText("Best Distance: " + bestdistanceConversion() , c.width/2 +40, c.height*0.93);
   ...
   function checkCollision() {
       ...
       function checksludgeCollision (s) {
           ...
           if (person.x < sludgeRight && personRight > s.x && person.y < sludgeBottom && personBottom > s.y) {
   ...
   // sludge collision
       ...
       function CollectpowerUp (P) {
           ...
           if (person.x< pRight && personRight > P.x && person.y < pBottom && personBottom > P.y) {
               health += 25;
               if (health > 100) {
                   health = 100;
               }
